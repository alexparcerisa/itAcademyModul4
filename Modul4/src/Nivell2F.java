...
public class Nivell2F {
	...
	static void desglossamentBitllets() {
		...
		System.out.println("Faran falta : " + qBitllet500 + " Bitllets de 500; " + qBitllet200 + " Bitllets de 200; " 
							+ qBitllet100 + " Bitllets de 100; " + qBitllet50 + " Bitllets de 50; "
							+ qBitllet20 + " Bitllets de 20; " + qBitllet10 + " Bitllets de 10; "
							+ qBitllet5 + " Bitllets de 5; " + qBitllet1 + " Bitllets de 1.");
		...
		do {	
			...
			try {
				if (plat<0 || plat>=plats.length) {
					...
					throw new InputMismatchException("Plats de l'1 al 9");
				...
				System.out.println("Error, has de triar un plat entre 1 i 9");
			}
				
			do {
				
				ok = getValor(entrada, "Vols continuar comprant? 1:SI / 2:NO");
